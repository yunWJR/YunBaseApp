...
#import "YunNavigationController.h"
#import "YunConfig.h"

@interface YunNavigationController () <UIGestureRecognizerDelegate, UINavigationControllerDelegate> {
    UIImageView *_navBarHairlineImageView;
}

@end

@implementation YunNavigationController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _poppGes = YunConfig.instance.nagVcPopGes;
...
- (void)setBackVcNeedUpdate {
    if ([self.backVC isKindOfClass:YunNavigationController.class]) {
        ((YunNavigationController *) self.backVC).needUpdateData = YES;
    }
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    if (self.viewControllers.count > 0 && _poppGes) {
