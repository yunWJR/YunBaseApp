...
- (void)initViewWithButtons:(NSArray<NSString *> *)btnTitles {
    ...
    if (_btnList.count == 1) {
        ...
        [_btnList[0] mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(_ctnLabel.mas_bottom).offset(5);
...
- (void)initViews {
    ...
    [_titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_contentView).offset(self.ctnIntervalV);
        make.centerX.equalTo(_contentView);
    ...
    [_ctnLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(_contentView);
        make.width.lessThanOrEqualTo(_contentView).offset(-self.sideOff * 2);
...
- (void)showView {
    ...
    //    CGFloat ctnHeight = (YunSizeHelper.screenWidth-40)*0.77;
    //    CGFloat lblHt = ctnHeight-_btnHeight-self.bottomOff-5-self.ctnIntervalV;
    //
    ...
    CGFloat ctnHeight = 200;
    [_contentView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(ctnHeight);
    }];
