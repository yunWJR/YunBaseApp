...
//! Project version number for YunBaseApp.
FOUNDATION_EXPORT double YunBaseAppVersionNumber;

//! Project version string for YunBaseApp.
FOUNDATION_EXPORT const unsigned char YunBaseAppVersionString[];
